      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-primary/10 via-background to-background">
        ...
        >
          <h1 className="text-4xl font-bold sm:text-6xl mb-6 ">
            <div className="sm:inline mt-2 sm:mt-0">{info.name}</div>
          </h1>
          <div>
          ...
          <div className="mt-4">
            <span className="bg-primary text-primary-foreground">Bg Primary</span>{" | "}
            <span className="bg-secondary text-secondary-foreground">Bg Secondary</span>{" | "}
            ...
            <span className="bg-destructive text-destructive-foreground">Bg Destructive</span>{" | "}
            <span className="bg-success text-success-foreground">Bg Success</span>
          </div>
          <div className="mt-4">
